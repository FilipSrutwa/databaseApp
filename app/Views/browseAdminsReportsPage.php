...
<div class="container-fluid d-flex flex-row flex-wrap">
  ...
  foreach ($dataToShow as $report) {
    ...
    <div class="card-body">
      <h5 class="card-title">ID użytkownika: ' . $report['ID_admina'] . '</h5>
      <p class="card-text">Treść wniosku:</br>' . $report['Tekst'] . '</p>
      <p class="card-text">Data przyjęcia zgłoszenia: ' . $report['Created_at'] . '</p>
      <form method="post">
